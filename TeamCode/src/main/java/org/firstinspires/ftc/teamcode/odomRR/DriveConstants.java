...
public class DriveConstants {
     ...
     * to degrade. As of now, it simply mirrors the velocity results in 38.110287416570166 in/s/s
     *
     * Maximum Angular Velocity is calculated as: maximum velocity / (trackWidth / 2) * (180 / Math.PI)

     */
    public static DriveConstraints BASE_CONSTRAINTS = new DriveConstraints(
            38.110287416570166, 38.110287416570166, 0.0,
            Math.toRadians(276.3998259493671), Math.toRadians(276.3998259493671), 0.0
    );
