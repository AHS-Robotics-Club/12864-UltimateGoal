...
public class GroupFour_Shoot extends SequentialCommandGroup {
    public GroupFour_Shoot(DriveSystem drive, ElapsedTime time, VoltageSensor voltageSensor, RevIMU imu,
        ...
        addCommands(
                ...
                new Com_RotateTo(drive, imu, 0),
                new Com_DriveTime(drive, 0D, -0.55, 0D, time, 5.5),
                ...
                new ElapsedWait(1000),
                new Com_RotateTo(drive, imu, 0),
                new Com_DriveTime(drive, 0D, 0.55, 0D, time, 2.2)
        );
    }
}
